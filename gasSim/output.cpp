...
void printStat(TdStats stats) {
  ...
  std::cout << "║ ▸ Statistics                                       ║\n";
  std::cout << "║   • " << std::left << std::setw(23) << "Pression on front"
            << ": " << std::right << std::setw(6) << pressFront
            << "           ║\n";
  std::cout << "║   • " << std::left << std::setw(23) << "Pression on back"
            << ": " << std::right << std::setw(6) << pressBack
            << "           ║\n";
  std::cout << "║   • " << std::left << std::setw(23) << "Pression on left"
            << ": " << std::right << std::setw(6) << pressLeft
            << "           ║\n";
  std::cout << "║   • " << std::left << std::setw(23) << "Pression on right"
            << ": " << std::right << std::setw(6) << pressRight
            << "           ║\n";
  std::cout << "║   • " << std::left << std::setw(23) << "Pression on top"
            << ": " << std::right << std::setw(6) << pressTop
            << "           ║\n";
  std::cout << "║   • " << std::left << std::setw(23) << "Pression on bottom"
